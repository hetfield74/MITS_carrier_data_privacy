...
',
  ...
  'MODULE_' . $modulname . '_MULTIPLE_ACCEPTS_TITLE' => 'Autoriser plusieurs r&eacute;vocations/consentements&nbsp;?',
  'MODULE_' . $modulname . '_MULTIPLE_ACCEPTS_DESC'  => 'Si la valeur <strong>true</strong> est s&eacute;lectionn&eacute;e, le client peut retirer et donner son consentement aussi souvent qu\'il le souhaite. Avec <strong>false</strong> <i>(recommand&eacute;)</i>, une seule acceptation ult&eacute;rieure (si elle n\'a pas &eacute;t&eacute; donn&eacute;e lors du processus de commande) et un seul retrait sont autoris&eacute;s&nbsp;!',
  'MODULE_' . $modulname . '_DEFAULT_ADDRESS_TITLE'  => 'Adresse standard du prestataire de livraison',
  'MODULE_' . $modulname . '_DEFAULT_ADDRESS_DESC'   => 'Utiliser cette adresse comme adresse standard pour les prestataires de livraison. Elle est affich&eacute;e par exemple lorsque le client n\'a pas encore choisi de mode d\'exp&eacute;dition lors du checkout ou lorsqu\'aucune adresse n\'a &eacute;t&eacute; associ&eacute;e au mode d\'exp&eacute;dition correspondant.',
