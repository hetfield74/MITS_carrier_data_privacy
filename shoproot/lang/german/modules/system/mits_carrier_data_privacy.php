...
',
  ...
  'MODULE_' . $modulname . '_MULTIPLE_ACCEPTS_TITLE' => 'Mehrfaches Widerrufen/Zustimmen erm&ouml;glichen?',
  'MODULE_' . $modulname . '_MULTIPLE_ACCEPTS_DESC'  => 'Bei Auswahl <strong>true</strong> kann der Kunde so oft widerrufen und zustimmen, wie er m&ouml;chte. Bei <strong>false</strong> <i>(empfohlen)</i> ist nur eine nachtr&auml;gliche Zustimung (falls diese beim Bestellvorgang noch nicht erteilt wurde) und ein Widerruf erlaubt!',
  'MODULE_' . $modulname . '_DEFAULT_ADDRESS_TITLE'  => 'Paketdienstleister Standard-Adresse',
  'MODULE_' . $modulname . '_DEFAULT_ADDRESS_DESC'   => 'Diese Adresse als Standard-Adresse für Paketdienstleister verwenden. Wird z.B. dann angezeigt, wenn der Kunde im Checkout noch keine Versandart gew&auml;hlt hat oder falls keine Adresse bei der jeweiligen Versandart zugeordnet wurde.',
